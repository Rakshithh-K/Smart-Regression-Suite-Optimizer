    ...
    <div className="rounded-xl border border-slate-200 bg-white shadow-xs overflow-hidden">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
        ...
        <div className="p-5 sm:p-6">
          ...
          <p className="mt-2 text-3xl sm:text-4xl font-bold tracking-tight text-slate-900 font-mono">
        ...
        <div className="p-5 sm:p-6">
          ...
          <p className="mt-2 text-3xl sm:text-4xl font-bold tracking-tight text-indigo-600 font-mono">
            {timeUsed} <span className="text-base sm:text-lg font-medium text-slate-500 font-sans">min</span>
          </p>
          <p className="mt-1.5 text-sm text-slate-500 font-normal">
        ...
        <div className="p-5 sm:p-6">
          ...
          <p className="mt-2 text-3xl sm:text-4xl font-bold tracking-tight text-slate-800 font-mono">
            {timeBudget} <span className="text-base sm:text-lg font-medium text-slate-500 font-sans">min</span>
          </p>
          <p className="mt-1.5 text-sm text-slate-500 font-normal">
        ...
        <div className="p-5 sm:p-6">
          ...
          <p
            className={`mt-2 text-3xl sm:text-4xl font-bold tracking-tight font-mono ${
