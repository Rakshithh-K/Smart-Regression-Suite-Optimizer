  ...
  return (
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 pb-6 border-b border-slate-200">
      ...
      <div className="max-w-3xl">
        <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 block mb-1.5 font-mono">
      ...
      <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 shrink-0 pb-1">
        ...
        <ArrowRight size={13} className="text-slate-400 shrink-0" />
        <span className="rounded-md bg-indigo-50 border border-indigo-200 px-2.5 py-1 text-indigo-700 font-bold">
          Optimize
        </span>
      </div>
    </div>
